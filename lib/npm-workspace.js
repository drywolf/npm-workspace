...
self.installWorkspace = function(cwd, installed) {
  ...
  // apply extra directories configured in the workspace description
  if (wsDesc && wsDesc.dirs)
    files = files.concat(wsDesc.dirs.map(function(d) { return path.join(cwd, d); }));
